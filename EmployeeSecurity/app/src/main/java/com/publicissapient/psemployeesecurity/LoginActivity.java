...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            BasicNameValuePair usernameBasicNameValuePair = new BasicNameValuePair(
                    "username", mEmail);  // Make your own key value pair
            BasicNameValuePair passwordBasicNameValuePAir = new BasicNameValuePair(
                    "password", mPassword);// make your own key value pair
            ...
            try {
                ...
                try {
                    ...
                    Map<String,String> map = jsonToMap(responseStrin);
                    ...
                    {
                        storeToSharedStorage(sessionId,map.get("role"));
                        //store json to storage
                        System.out.println("valid");
                        //route to correct activity now
                        return true;
                    }
    ...
    private void storeToSharedStorage(String sessionId,String role)
    {
        ...
        editor.putString(getString(R.string.user_role), role);
        editor.commit();
    }
}
